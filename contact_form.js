export const initContactForm = () => {
  ...
  const issueData = {
    ...
    "Safety and Preventive": [
      "Burning or Gas Smell (Emergency)",
  ...
  const renderForm = () => {
    container.innerHTML = `
      <div id="form-inner">
        ...
        <form id="hvac-contact-form" class="space-y-4">
          ...
          <div class="grid md:grid-cols-2 gap-4">
            <input type="tel" id="phone" placeholder="PHONE (704) 000-0000" required pattern=".{10,}" title="Please include area code" class="w-full bg-slate-900 border border-slate-800 p-5 text-xs tracking-widest text-white focus:border-[#B87333] outline-none transition-all uppercase font-bold" />
    ...
    categorySelect.addEventListener('change', (e) => {
      ...
      if (selectedCat === "Safety and Preventive" || selectedCat === "Urgent: Call Immediately") {
