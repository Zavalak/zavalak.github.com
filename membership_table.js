export const initMembershipTable = () => {
  ...
  const tiers = [
    { 
      ...
      price: "$0.00", 
      highlight: false, 
      data: ["$129.00", "$129.00", "$199.99/hr", "---", "$249.99", "$249.99", "---", "---", "---"] 
    },
    { 
      name: "Non-Member", 
      price: "$0.00", 
      highlight: false, 
      data: ["$79.99", "$79.99", "$199.99/hr", "Standard", "$249.99", "$249.99", "$79.99", "Yes", "---"] 
    },
    { 
      name: "Basic Member", 
      // Slanted slash added to original price for 20% discount visualization
      price: `<span class="slanted-slash opacity-40 text-sm sm:text-lg block mb-1">$249.99</span>$199.99`, 
      highlight: false, 
      data: ["WAIVED*", "$49.99", "$149.99/hr", "Standard", "INCLUDED", "INCLUDED", "$49.99", "Yes", "---"] 
    },
    { 
      name: "Premium Member", 
      // Slanted slash added to original price for 20% discount visualization
      price: `<span class="slanted-slash opacity-40 text-sm sm:text-lg block mb-1">$499.99</span>$399.99`, 
      highlight: true, 
  ...
  const rows = [
    "Primary System Diagnostic", // Updated for clarity
    "Additional System (Same Trip)", // Clarifies multi-unit pricing
    ...
    <div class="max-w-3xl mx-auto mt-10 sm:mt-16 space-y-4 px-4 text-center">
      ...
      <div class="border-b border-white/5 pb-6">
        ...
        <p class="text-xs sm:text-sm text-slate-500 leading-relaxed font-medium">
          Membership benefits cover the primary HVAC system at the residence. Because each mechanical unit requires a separate, comprehensive safety and performance evaluation, additional systems are billed at a discounted 'Member Rate' during the same service visit. New Business enrollees receive an additional 20% off their initial membership dues. Call (704) 218-9286 to activate this one-time discount.
        </p>
      </div>
    </div>
  `;
