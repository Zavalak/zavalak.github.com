export const initMembershipTable = () => {
  ...
  const tiers = [
    ...
    { 
      name: "Basic Member", 
      // Slanted slash added to original price
    ...
    <div class="max-w-3xl mx-auto mt-10 sm:mt-16 space-y-4 px-4 text-center">
      ...
      <div class="border-b border-white/5 pb-6">
        ...
        <p class="text-xs sm:text-sm text-slate-500 leading-relaxed font-medium">
          New Business enrollees receive an additional 20% off their initial membership dues. All subsequent services follow established tier pricing. Call (704) 218-9286 to activate this one-time discount.
        </p>
      </div>
    </div>
  `;
