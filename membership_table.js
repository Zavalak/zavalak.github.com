export const initMembershipTable = () => {
  ...
  const tiers = [
    ...
    { name: "Basic Member", price: "$249.99", highlight: false, data: ["Waived*<br/><span class='opacity-60 text-[8px]'>$49.99</span>", "$39.99", "$149.99/hr", "Standard", "INCLUDED", "INCLUDED", "$49.99", "Yes", "---"] },
    { name: "Premium Member", price: "$499.99", highlight: true, data: ["Waived", "Waived", "$99.99/hr", "15% discount", "INCLUDED", "INCLUDED", "Waived", "WAIVED", "Under 24h"] }
  ];
    ...
    <div class="max-w-3xl mx-auto mt-10 sm:mt-16 space-y-4 px-4">
      ...
      <div class="border-b border-white/5 pb-6">
        ...
        <p class="text-xs sm:text-sm text-slate-500 leading-relaxed font-medium">
          The 'First On-Site Diagnostic Waived' benefit for the Basic Member tier is an exclusive incentive for new members during their first year of enrollment. All subsequent diagnostics are performed at the significantly reduced membership rate established for your tier.
        </p>
      </div>
    </div>
  `;
